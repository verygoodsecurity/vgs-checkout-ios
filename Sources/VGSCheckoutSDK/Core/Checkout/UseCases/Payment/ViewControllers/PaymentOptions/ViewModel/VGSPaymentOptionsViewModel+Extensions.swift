...
internal extension VGSPaymentOptionsViewModel {
	...
	static func provideMockedData() -> [VGSPaymentOption] {
		return [
			.savedCard(VGSSavedCardModel(id: "1", cardBrand: "visa", last4: "1234", expDate: "12/22", cardHolder: "John Smith 1 Smith M")),
			.savedCard(VGSSavedCardModel(id: "2", cardBrand: "maestro", last4: "5678", expDate: "01/23", cardHolder: "John Smith 2")),
			.savedCard(VGSSavedCardModel(id: "3", cardBrand: "visa", last4: "1234", expDate: "12/24", cardHolder: "John Smith 3")),
			.savedCard(VGSSavedCardModel(id: "4", cardBrand: "maestro", last4: "5678", expDate: "01/25", cardHolder: "John Smith 4")),
//			.savedCard(VGSSavedCardModel(id: "5", cardBrand: "visa", last4: "1234", expDate: "12/26", cardHolder: "John Smith 4")),
//			.savedCard(VGSSavedCardModel(id: "6", cardBrand: "maestro", last4: "5678", expDate: "01/27", cardHolder: "John Smith 5")),
//			.savedCard(VGSSavedCardModel(id: "7", cardBrand: "visa", last4: "1234", expDate: "12/28", cardHolder: "John Smith")),
//			.savedCard(VGSSavedCardModel(id: "8", cardBrand: "maestro", last4: "5678", expDate: "01/29", cardHolder: "John Smith 6")),
//			.savedCard(VGSSavedCardModel(id: "9", cardBrand: "visa", last4: "1234", expDate: "12/30", cardHolder: "John Smith")),
//			.savedCard(VGSSavedCardModel(id: "10", cardBrand: "maestro", last4: "5678", expDate: "01/31", cardHolder: "John Smith 7")),
//			.savedCard(VGSSavedCardModel(id: "11", cardBrand: "visa", last4: "1234", expDate: "12/32", cardHolder: "John Smith")),
//			.savedCard(VGSSavedCardModel(id: "12", cardBrand: "maestro", last4: "5678", expDate: "01/33", cardHolder: "John Smith 8")),
			.newCard
		]
	}
}
