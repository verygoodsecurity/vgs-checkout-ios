...
internal extension VGSPaymentOptionsViewModel {
	...
	static func provideMockedData() -> [VGSPaymentOption] {
		return [
			.savedCard(VGSSavedCardModel(id: "1", cardBrand: "visa", last4: "1231", expDate: "12/22", cardHolder: "John Smith")),
			.savedCard(VGSSavedCardModel(id: "2", cardBrand: "maestro", last4: "1488", expDate: "01/23", cardHolder: "John Smith")),
