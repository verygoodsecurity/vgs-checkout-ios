...
internal final class VGSPayWithCardViewModelFactory {
	...
	internal static func buildAddCardViewModel(with checkoutConfigurationType: VGSCheckoutConfigurationType, vgsCollect: VGSCollect) -> VGSPayoptTransfersPayWithNewCardViewModel {
		...
		case .payoptTransfers(let configuration):
			return VGSPayoptTransfersPayWithNewCardViewModel(configuration: configuration, vgsCollect: vgsCollect)
		}
	}
	...
	internal static func buildPaymentOptionsViewModel(with checkoutConfigurationType: VGSCheckoutConfigurationType, vgsCollect: VGSCollect) -> VGSPaymentOptionsViewModel {
		...
		case .payoptTransfers(let configuration):
			return VGSPaymentOptionsViewModel(configuration: configuration, vgsCollect: vgsCollect)
		}
	}
}
