...
internal class VGSCardDataFormConfigurationManager {
	...
	*/
	...
	internal static func setupCardForm(with multiplexingConfiguration: VGSCheckoutMultiplexingBasicConfiguration, vgsCollect: VGSCollect, cardSectionView: VGSCardDetailsSectionView) {
