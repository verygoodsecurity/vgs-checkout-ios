...
internal class VGSAddressDataFormConfigurationManager {
	...
	*/
	...
	internal static func setupAddressForm(with multiplexingConfiguration: VGSCheckoutMultiplexingBasicConfiguration, vgsCollect: VGSCollect, addressFormView: VGSBillingAddressDetailsSectionView) {
