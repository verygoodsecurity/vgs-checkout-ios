...
final internal class VGSAddressDataSectionViewModel: VGSBaseFormSectionProtocol, VGSPlaceholderFieldViewDelegate, VGSPickerTextFieldSelectionDelegate {
  ...
  internal convenience init(vgsCollect: VGSCollect, configuration: VGSCheckoutMultiplexingAddCardConfiguration, validationBehavior: VGSCheckoutFormValidationBehaviour, uiTheme: VGSCheckoutThemeProtocol, formValidationHelper: VGSFormValidationHelper, autoFocusManager: VGSFieldAutofocusManager) {
    self.init(vgsCollect: vgsCollect, validationBehavior: validationBehavior, uiTheme: uiTheme, formValidationHelper: formValidationHelper, autoFocusManager: autoFocusManager, checkoutConfigurationType: .multiplexingAddCard(configuration))

		setupBillingAddressForm(with: configuration)
    buildForm()
  }

	internal convenience init(vgsCollect: VGSCollect, configuration: VGSCheckoutMultiplexingPaymentConfiguration, validationBehavior: VGSCheckoutFormValidationBehaviour, uiTheme: VGSCheckoutThemeProtocol, formValidationHelper: VGSFormValidationHelper, autoFocusManager: VGSFieldAutofocusManager) {
		self.init(vgsCollect: vgsCollect, validationBehavior: validationBehavior, uiTheme: uiTheme, formValidationHelper: formValidationHelper, autoFocusManager: autoFocusManager, checkoutConfigurationType: .multiplexingPayment(configuration))
  ...
  internal func buildForm() {
	...
	/// - Parameter multiplexingConfiguration: `VGSCheckoutMultiplexingBasicConfiguration` object, multiplexing configuration.
	private func setupBillingAddressForm(with multiplexingConfiguration: VGSCheckoutMultiplexingBasicConfiguration) {
