...
public struct VGSCheckoutMultiplexingAddCardConfiguration: VGSCheckoutBasicConfigurationProtocol, VGSCheckoutMultiplexingBasicConfiguration {
...
internal protocol VGSCheckoutMultiplexingBasicConfiguration {

	/// Form configuration options.
	var formConfiguration: VGSMultiplexingFormConfiguration {get set}

	var billingAddressCountryFieldOptions: VGSCheckoutMultiplexingBillingAddressCountryOptions {get set}
